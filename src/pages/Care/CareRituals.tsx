...
import yule from '../../assets/img/soins-rituels/yule-1.webp'
    ...
    <div className="care-rituals">
      ...
      <div className="rituals-description">
        ...
        <div className="season-ritual">
          ...
          <div>
            <h3>En ce moment, découvrez le rituels de Yule :</h3>
            <div className="ritual-item">
              <img src={yule} alt="" loading="lazy"/>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime voluptates, 
                sint cupiditate culpa, vitae voluptas excepturi vel et beatae fugiat eos maiores 
                iste soluta nisi! Nihil soluta labore sequi voluptas.
        ...
        <div>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sed, dolor explicabo. Ipsa, 
            modi repellendus nulla ratione iusto voluptatibus eum voluptate obcaecati nobis? Vitae,
             temporibus perferendis minus laborum atque odit molestias.
          </p>
          ...
          <div className="rituals-line">
          <div className="ritual-item">
            <img src={gardienTerre} alt="" loading="lazy"/>
      ...
      <div className="explication-rituals">
        <p>
